...
## <a name="static-extend" href="../benchmark.js#L391">Benchmark.extend(destination, source)</a>
...
## <a name="static-filter" href="../benchmark.js#L406">Benchmark.filter(array, callback)</a>
...
## <a name="static-forIn" href="../benchmark.js#L419">Benchmark.forIn(object, callback)</a>
...
## <a name="static-formatNumber" href="../benchmark.js#L434">Benchmark.formatNumber(number)</a>
...
## <a name="static-hasKey" href="../benchmark.js#L452">Benchmark.hasKey(object, key)</a>
...
## <a name="static-indexOf" href="../benchmark.js#L481">Benchmark.indexOf(array, value)</a>
...
## <a name="static-interpolate" href="../benchmark.js#L587">Benchmark.interpolate(string, object)</a>
...
## <a name="static-invoke" href="../benchmark.js#L500">Benchmark.invoke(benches, methodName, args)</a>
...
## <a name="static-isArray" href="../benchmark.js#L602">Benchmark.isArray(value)</a>
...
## <a name="static-isCalibrated" href="../benchmark.js#L612">Benchmark.isCalibrated()</a>
Checks if calibration benchmarks have completed. <sub>[&not;][1]</sub>

### Returns
*(Boolean)*: Returns true if calibrated, false if not.

## <a name="static-isClassOf" href="../benchmark.js#L625">Benchmark.isClassOf(object, name)</a>
...
## <a name="static-isHostType" href="../benchmark.js#L639">Benchmark.isHostType(object, property)</a>
...
## <a name="static-join" href="../benchmark.js#L653">Benchmark.join(object, separator1, separator2)</a>
...
## <a name="static-map" href="../benchmark.js#L675">Benchmark.map(array, callback)</a>
...
## <a name="static-noop" href="../benchmark.js#L687">Benchmark.noop()</a>
A no operation function. <sub>[&not;][1]</sub>

## <a name="static-reduce" href="../benchmark.js#L700">Benchmark.reduce(array, callback, accumulator)</a>
...
## <a name="static-trim" href="../benchmark.js#L714">Benchmark.trim(string)</a>
...
## <a name="addListener" href="../benchmark.js#L727">Benchmark#addListener(type, listener)</a>
...
## <a name="clone" href="../benchmark.js#L822">Benchmark#clone(options)</a>
...
## <a name="compare" href="../benchmark.js#L842">Benchmark#compare(other)</a>
...
## <a name="emit" href="../benchmark.js#L741">Benchmark#emit(type)</a>
Executes all registered listeners of a specified event type. <sub>[&not;][1]</sub>

### Arguments
1. `type` *(String)*: The event type.

## <a name="removeAllListeners" href="../benchmark.js#L782">Benchmark#removeAllListeners(type)</a>
...
## <a name="removeListener" href="../benchmark.js#L764">Benchmark#removeListener(type, listener)</a>
...
## <a name="toString" href="../benchmark.js#L890">Benchmark#toString()</a>
