...
declare class Benchmark {
    ...
    constructor(fn: Function | ((this: Benchmark) => void) | string, options?: Benchmark.Options);
    constructor(name: string, fn: Function | ((this: Benchmark) => void) | string, options?: Benchmark.Options);
